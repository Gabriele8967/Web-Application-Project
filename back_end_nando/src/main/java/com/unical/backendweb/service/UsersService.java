...
public class UsersService {
    ...
    public UsersService() {
        ...
        users.add(createUserResponse(2L, "Filippo", "Turetta", "philipTurets", "filippo.turetta@email.com", 67890, "/assets/image/campo5.jpg", 2));
        users.add(createUserResponse(3L, "Pietro", "Pacciani", "ilmostro", "pietro.pacciani@email.com", 13579, "/assets/image/campo5.jpg", 3));
    }
